class Player(object):
    ...
    def take_turn(self):
        ...
        dice_total = fv1 + fv2
        return self.move_token_by(dice_total)

    def move_token_by(self, dice_total):
        current_position = self.get_position()
        return self.board.get_new_position(dice_total, current_position)
...
class Game(object):
    ...
    def initialise(self, num_players, num_rounds):
        ...
        for x in range(num_players):
            ...
            self.players[x].set_board(self.board)
